...
/**
 * Pure highlight rule extracted from the (removed) Tasks UI: a view-mode option is highlighted
 * iff it is the currently selected mode. Kept here so the Property-13 tests remain meaningful.
 */
private fun isViewModeHighlighted(mode: TaskViewMode, selectedMode: TaskViewMode): Boolean =
    mode == selectedMode

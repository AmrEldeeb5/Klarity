...
- **Bring your own model** — Anthropic (Claude), OpenAI, or any OpenAI-compatible endpoint (Groq, OpenRouter, Ollama, LM Studio, …). Without a key, Lou answers from local search only.

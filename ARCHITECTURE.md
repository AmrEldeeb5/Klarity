# Sentio Architecture Guide

This document explains the complete architecture of Sentio, from data layer to presentation layer, following **MVVM Clean Architecture** principles.
